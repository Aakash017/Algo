...
# compress_video('/Users/aakashsharma/Desktop/Screen Recording 2023-05-05 at 9.40.55 AM.mov', 'Screen Recording '
#                                                                                             '2023-05-05 at 9.40.55 '
#                                                                                             'AM.mp4', 15 * 1000)
...
def resize_video(
    ...
    # {'index': 0, 'codec_name': 'h264', 'codec_long_name': 'H.264 / AVC / MPEG-4 AVC / MPEG-4 part 10', 'profile':
    # 'Main', 'codec_type': 'video', 'codec_tag_string': 'avc1', 'codec_tag': '0x31637661', 'width': 1280,
    # 'height': 720, 'coded_width': 1280, 'coded_height': 720, 'closed_captions': 0, 'film_grain': 0, 'has_b_frames':
    # 1, 'sample_aspect_ratio': '1:1', 'display_aspect_ratio': '16:9', 'pix_fmt': 'yuv420p', 'level': 31,
    # 'color_range': 'tv', 'color_space': 'bt709', 'color_transfer': 'bt709', 'color_primaries': 'bt709',
    # 'chroma_location': 'left', 'field_order': 'progressive', 'refs': 1, 'is_avc': 'true', 'nal_length_size': '4',
    # 'id': '0x1', 'r_frame_rate': '25/1', 'avg_frame_rate': '25/1', 'time_base': '1/12800', 'start_pts': 0,
    # 'start_time': '0.000000', 'duration_ts': 4096000, 'duration': '320.000000', 'bit_rate': '71355',
    # 'bits_per_raw_sample': '8', 'nb_frames': '8000', 'extradata_size': 43, 'disposition': {'default': 1, 'dub': 0,
    # 'original': 0, 'comment': 0, 'lyrics': 0, 'karaoke': 0, 'forced': 0, 'hearing_impaired': 0, 'visual_impaired':
    # 0, 'clean_effects': 0, 'attached_pic': 0, 'timed_thumbnails': 0, 'captions': 0, 'descriptions': 0, 'metadata':
    # 0, 'dependent': 0, 'still_image': 0}, 'tags': {'creation_time': '2022-06-14T17:31:48.000000Z', 'language':
    # 'und', 'handler_name': 'ISO Media file produced by Google Inc. Created on: 06/14/2022.', 'vendor_id': '[0][0][
    # 0][0]'}}
...
file_absolute_path = resize_video(
    video_absolute_path='/Users/aakashsharma/Desktop/Screen Recording 2023-05-05 at 9.40.55 AM.mov',
    size_upper_bound=16 * 1000,
